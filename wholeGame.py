...
# import sys
# import time
# from ballonGame import balloon_shooter_game
...
# import time
# from ballonGame import balloon_shooter_game
# from touchBallon import touch_balloon_popping_game
...
# BELOW IS FULL COMPLETED WITH ALL THE IMAGES IN NAVIGATION GAME
...
#                 if game_state == NAVIGATION:
#                     if event.key == pygame.K_RIGHT:
#                      bg_x -= scroll_speed * 19  # Adjust scroll speed for visible movement
#                     elif event.key == pygame.K_LEFT:
#                      bg_x += scroll_speed * 19
...
#             # Scroll background images
#             bg_x %= screen_width  # Wrap background position
#             screen.blit(bg_images[0], (bg_x - screen_width, 0))  # Draw previous image
#             screen.blit(bg_images[1], (bg_x, 0))                # Draw current image
#             screen.blit(bg_images[0], (bg_x + screen_width, 0))  # Draw next image
#             # Draw character
#             screen.blit(girl_image, (screen_width // 2 - girl_image.get_width() // 2, screen_height - girl_image.get_height() - 50))
    ...
    while running:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if game_state == NAVIGATION:
                    if event.key == pygame.K_RIGHT:  
                     bg_x -= scroll_speed * 25  # Adjust scroll speed for visible movement
                    elif event.key == pygame.K_LEFT:
                     bg_x += scroll_speed * 25
